...
const getToken = editor => {
  ...
  if (token.string === "." || token.type === "qualifier") {
    return expandRight(
      ...
      line,
      token.end,
      expandLeft(editor, line, token.start, token.string)
    );
  }
...
const load = () => {
  return Promise.all([
    ...
    import(/* webpackChunkName: "codemirror-base" */ "./MarkupMode"),
    import(/* webpackChunkName: "codemirror-base" */ "codemirror/mode/gfm/gfm"),
      ...
      HTMLElement =>
        class CodeEditor extends HTMLElement {
          ...
          get token() {
            ...
            if (this._token === STALE_TOKEN)
              this._token = getToken(this._instance);
            return this._token;
          }
          ...
          connectedCallback() {
            ...
            this._instance = CodeMirror(this, {
              ...
              keyMap:
                this._vimModeLoadState === "FINISHED" && this._vimMode
                  ? "vim"
                  : "default",
