defmodule Ellie.Types.Revision do
  ...
  def changeset(revision, attrs) do
    revision
    |> cast(attrs, [:id, :title, :elm_code, :markup_code, :html_code, :packages, :elm_version, :terms_version])
    |> validate_required([:id, :elm_code, :markup_code, :html_code, :packages, :elm_version, :terms_version])
  end
end
